...
function IncreaseGrades() {
    ...
    const getIncreaseGrades= async () => {
        ...
        fetch(`${apiUrl}/increasegrades/${uid}`, requestOptions)
            ...
            <Container className={classes.container} maxWidth="lg">
                ...
                <TableContainer component={Paper} className={classes.tableSpace}>
                    <Table className={classes.table} aria-label="simple table">
                        ...
                        <TableBody>
                            {increasegrades.map((wd: IncreaseGradesInterface) => (
                                <TableRow key={wd.ID}>
                                    <TableCell align="center">{wd.Student.ID_student}</TableCell>
                                    <TableCell align="center">{wd.Course.Coursename}</TableCell>
                                    <TableCell align="center">{wd.Grades.Grade}</TableCell>
                                    <TableCell align="center">{format((new Date(wd.Date)), 'dd MMMM yyyy hh:mm a')}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
